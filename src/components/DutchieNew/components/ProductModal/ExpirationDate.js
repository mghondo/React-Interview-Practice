// src/components/DutchieNew/components/ExpirationDate.js
...
const ExpirationDate = () => {
  ...
  return (
    <div className="form-control input-control">
      <label htmlFor="input-input_Expiration date" id="input-label_Expiration date">
        Expiration date
      </label>
      <div className="input-field">
        <input
          aria-invalid="false"
          autoComplete="off"
          id="input-input_Expiration date"
          type="text"
          value={displayValue}
